...
const CreateCategory = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const { data } = await axios.post(`${host}/api/category/create-category`, { name: name },);
      if (data.success) {
  ...
  const handleUpdate = async (e) => {
    e.preventDefault();
    try {
      const { data } = await axios.put(`${host}/api/category/update-category/${selected._id}`, { 
        name: updatedName
       });
      if (data.success) {
        toast.success(data.message, tostifyOption);
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const { data } = await axios.delete(`${host}/api/category/delete-category/${id}`, { 
        name: updatedName
       });
      if (data.success) {
        toast.success(data.message, tostifyOption);
